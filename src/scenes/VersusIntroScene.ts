...
export class VersusIntroScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add.text(BASE_WIDTH / 2, 40, 'VS', { fontFamily: 'monospace', fontSize: '20px', color: '#ffd23f' }).setOrigin(0.5, 0.5);
    ...
    this.add.text(130, 240, `P1: ${p1Def.name.toUpperCase()}`, { fontFamily: 'monospace', fontSize: '9px', color: '#ffd23f' }).setOrigin(0.5, 0.5);
    ...
    this.add.text(BASE_WIDTH / 2, 90, `"${p1Def.introLine}"`, { fontFamily: 'monospace', fontSize: '8px', color: '#c8c8d8' }).setOrigin(0.5, 0.5);
